...
mathTutor(multiply);
// mathTutor(wrongAdd) returns a string rather than a number

/*
Argument of type '(a: any, b: any) => string' is not assignable to parameter of type 'OperatorFunction'.
  Type 'string' is not assignable to type 'number'.

23 mathTutor(wrongAdd)
*/